...
// export const LOAD_QUESTION_REQUEST = "quiz/loadQuestionsRequest"
// export const LOAD_QUESTION_SUCCESS = "quiz/loadQuestionSuccess"

// export const loadQuestions = () => {
//     const storedQuestions = JSON.parse(localStorage.getItem("questionText"));
//     return storedQuestions || Array.from({ length: 10 }, (_, index) => ({
//         id: index + 1,
//         questionText: "Who is the director of Man of Steel?",
